...
$$\mathbf{G}_{\mu \nu} = 2 \Re \langle \partial_\mu \Psi_\theta \vert (H_\lambda - \omega_\lambda ) \vert \partial_\nu \Psi_\theta \rangle $$
$$f_\mu = 2 \Re \langle \partial_\mu \Psi_\theta \vert H_\lambda \vert \Psi_\theta \rangle$$
